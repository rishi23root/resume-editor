...
BYR simplifies the art of resume crafting or any other LaTeX-based template ex - filling out (billing receipt), empowering individuals to put their best foot forward in the competitive job market.
contact for more information: [mail](mailto:contact@buildyourresume.online)
...
- ### Open Source Contribution:
  ...
  ## Frontend [Frontend](https://github.com/rishi23root/resume-editor/)

  ## Backend [backend](https://github.com/rishi23root/resume-curator/)
