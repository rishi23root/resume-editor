    ...
    <section id="pricing" className=" min-h-[65vh] fc fce w-full gap-2">
      ...
      <div className="flex-wrap w-full h-full gap-8 py-8 fr fcc">
        ...
        <EachCard
          ...
          buttonStyle={
            "w-full p-2 border bg-gradient-to-r from-blue-600 to-fuchsia-500 rounded-2xl border-stone-500 fcc"
          }
        />
...
function EachCard({
  ...
  return (
    <div
      className={cn(
        "p-6 gap-2 bg-[#252835] glass fcb fc w-72 rounded-3xl",
        className
      )}
    >
      <div className="gap-6 fss fc ">
