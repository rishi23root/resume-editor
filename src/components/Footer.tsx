    ...
    <>
      ...
      <footer className="w-full sm:fcb">
        ...
        <div className="flex flex-col lg:w-[60%] w-full gap-2 h-full py-2 ">
          <Link
            href={"/blog"}
            className="text-base font-medium text-center sm:text-right  text-white underline underline-offset-4 decoration-blue-400 rounded-sm p-1  bg-gradient-to-r from-transparent to-white/5"
          >
            Blogs
          </Link>
          <Link
